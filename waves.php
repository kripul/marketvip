...
<body>
  ...
  <div class="ui main container">
    <div class="ui secondary  menu">
      ...
      <a href="waves.php" class="item active" id="priceLastmenuwaves">WAVES</a>
...
$(document).ready(function () {
  ...
  function price(){
    ...
    $.getJSON('libs/hitbtc.php?i=WAVES', function(data){
    ...
    $.getJSON('libs/bittrex.php?i=WAVES', function(data){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/waves_idr/ticker', function(data) {
      ...
      document.getElementById('totalVIP').innerHTML = Math.floor(data.ticker.vol_waves);
      document.getElementById('totalVIPrp').innerHTML = convertToRupiah(Math.floor(data.ticker.vol_waves)*data.ticker.last);
      document.title = "WAVES " + convertToRupiah(data.ticker.last);
    });
  }
  ...
  function depth(){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/waves_idr/trades', function(data){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/waves_idr/depth', function(data){  
