...
<body>
  ...
  <div class="ui main container">
    <div class="ui secondary  menu">
      ...
      <a href="nxt.php" class="item active" id="priceLastmenultc">NXT</a>
...
$(document).ready(function () {
  ...
  function price(){
    ...
    $.getJSON('https://poloniex.com/public?command=returnTicker', function(data){
      document.getElementById('PoloniexLast').innerHTML = convertToRupiah(Math.floor(data.BTC_NXT.last*btcPrice));
      document.getElementById('PoloniexBid').innerHTML = convertToRupiah(Math.floor(data.BTC_NXT.highestBid*btcPrice));
      document.getElementById('PoloniexAsk').innerHTML = convertToRupiah(Math.floor(data.BTC_NXT.lowestAsk*btcPrice));
    });

    $.getJSON('libs/bittrex.php?i=nxt', function(data){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/nxt_idr/ticker', function(data) {
      ...
      document.getElementById('totalVIP').innerHTML = Math.floor(data.ticker.vol_nxt);
      document.getElementById('totalVIPrp').innerHTML = convertToRupiah(Math.floor(data.ticker.vol_nxt)*data.ticker.low);
      document.title = "NXT " + convertToRupiah(data.ticker.last);
    });
  }
  ...
  function depth(){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/nxt_idr/trades', function(data){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/nxt_idr/depth', function(data){  
