...
$(document).ready(function () {
  ...
  function price(){
    ...
    $.getJSON('libs/bittrex.php?i=XRP', function(data){
    ...
    $.getJSON('libs/hitbtc.php?i=XRP', function(data){
  ...
  function depth(){
    ...
    $.getJSON('https://vip.bitcoin.co.id/api/xrp_idr/trades', function(data){
